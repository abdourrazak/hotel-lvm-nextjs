...
export default function MiniSuitePage() {
    ...
    const roomImages = [
        "/mini suite/minisuite1.jpeg",
        "/mini suite/minisuite2.jpeg",
        "/mini suite/minisuite3.jpeg",
        "/mini suite/minisuite4.jpeg",
        "/mini suite/minisuite5.jpeg",
    ];
    ...
    const features = [
        "Lit king size luxueux",
        "Salle de bain avec baignoire et douche",
        "Salon séparé",
        "Balcon privé avec vue panoramique",
        "Téléphone direct",
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-8">
                            <div>
                                <h1 className="text-xl md:text-xl font-bold text-secondary">MINI SUITE</h1>
                            </div>
                            <div className="text-right">
                                <div className="text-xl font-bold text-primary">35,000 XAF</div>
                ...
                <div className="mb-8">
                    <div className="relative h-[60vh] md:h-[70vh] bg-black rounded-3xl overflow-hidden shadow-2xl group">
                        <Image
                            ...
                            alt={`MINI SUITE - Vue ${currentImageIndex + 1}`}
                            fill
                        ...
                        <Card className="shadow-xl border-0">
                            <CardContent className="p-8">
                                ...
                                <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                                    Découvrez notre <strong>MINI SUITE</strong>, le summum du luxe avec une vue panoramique sur la ville.
                                    Cette suite spacieuse dispose d'un salon séparé, d'une chambre avec lit king size,
                                    d'une salle de bain luxueuse avec baignoire et douche, et d'un balcon privé.
                                </p>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="p-6 space-y-6">
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-5 text-center">
                                            ...
                                            <div className="text-xl font-bold text-secondary">40 m²</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="border-t pt-6">
                                    <div className="bg-gradient-to-r from-primary/20 to-accent/20 rounded-xl p-6 text-center mb-6">
                                        ...
                                        <div className="text-4xl font-bold text-primary mb-1">35,000 XAF</div>
