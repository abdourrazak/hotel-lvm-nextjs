...
export default function ChambreStandardPage() {
    ...
    const roomImages = [
        "/classic rooms/classicRooms1.jpeg",
        "/classic rooms/classicRooms2.jpeg",
        "/classic rooms/classicRooms3.jpeg",
        "/classic rooms/classicRooms4.jpeg",
        "/classic rooms/classicRooms5.jpeg",
        "/classic rooms/classicRooms6.jpeg",
    ];
    ...
    const features = [
        "Lit double king size confortable",
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-8">
                            <div>
                                <h1 className="text-xl md:text-xl font-bold text-secondary">Chambre STANDARD</h1>
                            </div>
                            <div className="text-right">
                                <div className="text-xl font-bold text-primary">15,000 XAF</div>
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="mb-8">
                    <div className="relative h-[60vh] md:h-[70vh] bg-black rounded-3xl overflow-hidden shadow-2xl group">
                        <Image
                            ...
                            alt={`Chambre Standard - Vue ${currentImageIndex + 1}`}
                            fill
                ...
                {/* Grille de Miniatures - TRÈS GRANDE */}
                <div className="mb-12">
                        ...
                        <Card className="shadow-xl border-0">
                            <CardContent className="p-8">
                                ...
                                <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                                    Découvrez le charme de notre <strong>Chambre Standard</strong>, conçue pour offrir un confort optimal à un prix abordable.
                                    Idéale pour les voyageurs solos ou les couples, elle dispose d'un lit double confortable, d'une salle de bain privative
                                    moderne et de tous les équipements nécessaires pour un séjour agréable.
                                </p>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="p-6 space-y-6">
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-5 text-center">
                                            ...
                                            <div className="text-xl font-bold text-secondary">25 m²</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="border-t pt-6">
                                    <div className="bg-gradient-to-r from-primary/20 to-accent/20 rounded-xl p-6 text-center mb-6">
                                        ...
                                        <div className="text-4xl font-bold text-primary mb-1">15,000 XAF</div>
