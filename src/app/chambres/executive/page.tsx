...
export default function ChambreExecutivePage() {
                ...
                <div className="container mx-auto px-4 py-4">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-8">
                            <div>
                                <h1 className="text-xl md:text-xl font-bold text-secondary">Chambre EXECUTIVE</h1>
                            </div>
                            <div className="text-right">
                                <div className="text-xl font-bold text-primary">25,000 XAF</div>
                ...
                <div className="mb-8">
                    <div className="relative h-[60vh] md:h-[70vh] bg-black rounded-3xl overflow-hidden shadow-2xl group">
                        <Image
                            ...
                            alt={`Chambre EXECUTIVE - Vue ${currentImageIndex + 1}`}
                            fill
                        ...
                        <Card className="shadow-xl border-0">
                            <CardContent className="p-8">
                                ...
                                <p className="text-muted-foreground text-lg leading-relaxed mb-6">
                                    Découvrez notre <strong>Chambre EXECUTIVE</strong>, une chambre supérieure avec coin salon séparé.
                                    Idéale pour les voyages d'affaires ou les longs séjours, elle offre un espace de travail dédié,
                                    un lit king size premium et tous les équipements modernes pour votre confort.
                                </p>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="p-6 space-y-6">
                                <div>
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div className="bg-gradient-to-br from-primary/10 to-primary/5 rounded-xl p-5 text-center">
                                            ...
                                            <div className="text-xl font-bold text-secondary">35 m²</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="border-t pt-6">
                                    <div className="bg-gradient-to-r from-primary/20 to-accent/20 rounded-xl p-6 text-center mb-6">
                                        ...
                                        <div className="text-4xl font-bold text-primary mb-1">25,000 XAF</div>
